 ...
 */
public class And extends AbCPredicate {

	private AbCPredicate left;
	private AbCPredicate right;

	public And( AbCPredicate left , AbCPredicate right ) {
		super( AbCPredicate.PredicateType.AND );
	...
	public AbCPredicate close(AbCEnvironment environment) {
		return new And( left.close(environment) , right.close(environment) );
	}
