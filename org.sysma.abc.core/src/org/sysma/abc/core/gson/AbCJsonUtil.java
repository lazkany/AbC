...
public class AbCJsonUtil {
	 ...
	 * object is determined by relying on attribute {@link AbCJsonUtil#TYPE_ID}
	 */
	...
	public static JsonElement jsonFromObject( Object o , JsonSerializationContext context) {
		...
		json.add(AbCJsonUtil.TYPE_ID, new JsonPrimitive(o.getClass().getName()));
		json.add(AbCJsonUtil.VALUE_ID, context.serialize(o));
		return json;
	}
